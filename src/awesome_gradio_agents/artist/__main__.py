...
def make_app(fn, undo_fn, retry_fn, select_fn, library: str):
    ...
    <div style="display: flex; justify-content: center; align-items: center; gap: 1rem; padding: 1rem; width: 100%">
        ...
        <div>
            <h1 style="margin: 0 0 1rem 0">Artist Agent 🎨</h1>
            <h3 style="margin: 0 0 0.5rem 0">
                The agent can generate images based on your prompt.
            </h3>
        </div>
    </div>
        """)
        ...
        chatbot = gr.Chatbot(
            ...
            examples=[
                {
                    "text": "Genereate three images of an astronaut riding an alligator in different styles and pick the best one."
                },
                {
                    "text": "I am in the mood for a painting of a sunset over a mountain."
                },
            ],
...
if __name__ == "__main__":
    ...
    if args.library == "pydantic_ai":
        from awesome_gradio_agents.artist.pydantic_ai import (
            handle_retry,
            select_data,
            stream_from_agent,
            undo,
        ...
        from awesome_gradio_agents.artist.transformers import (
            handle_retry,
            select_data,
            stream_from_agent,
            undo,
